...
from app.database.models import Astrologer, AuditEvent, AuthSession, PasswordResetToken, User  # noqa: E402
from app.tests.api_test_db import create_sqlite_test_session_factory, make_get_db_override, reset_sqlite_schema  # noqa: E402


engine, TestingSessionLocal = create_sqlite_test_session_factory("./_auth_password_reset_test.sqlite3")
