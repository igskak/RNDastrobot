...
_JUDGE_SYSTEM = (
    ...
    "BLOCK any reply that assigns real-world MEANING or characterizes a person or life "
    "area — evaluative words applied to a chart factor such as 'hard', 'challenging', "
    "'difficult', 'tension', 'brings', 'points to', 'reflects', 'dominates', 'indicates', "
    "'suggests', 'means' — and any statement about a person, life area, personality, "
    "emotion, outcome, or meaning. Do NOT block data-level HIGHLIGHTING: identifying which "
    "elements are notable by objective measures (most-aspected, tightest orb, rarest, most "
    "clustered) and suggesting which data points to examine is ALLOW.\n\n"
    ...
    "ALLOW: 'The busiest window is spring 2027, with 4 exact contacts.'\n"
    "ALLOW: 'Key data points to examine: the two exact Saturn contacts and the "
    "retrograde Mars station.'\n"
    ...
    "Judge the CLAIM, never the vocabulary. Do NOT block a reply merely because "
    "it contains the words analysis, analyse, forecast, future, period, important, "
    "significant, key, notable, event, relationship, career, money or health: "
    "naming a subject is not a claim about it. 'The densest period falls in "
    "August-October 2027' is a measurement even though it says period; 'this "
    "period will strain your career' is a claim about a life area and is blocked. "
    "Ask what the sentence ASSERTS about the person, not which words it uses.\n\n"
    "Further ALLOW examples that a keyword screen would wrongly block:\n"
    "ALLOW: 'Key data points to examine over the next two years: the three exact "
    "Pluto contacts and the retrograde Uranus station.'\n"
    "ALLOW: 'The analysis covers 22 contacts; activity forms three clusters.'\n"
    "ALLOW: 'This is the most significant contact by every declared metric: "
    "tightest orb, most exact passes and longest window.'\n"
    "ALLOW: 'Venus is the most repeatedly activated natal point in the period.'\n\n"
