import{a as Pt}from"./chunks/chunk-2YZIQGJC.js";import"./chunks/chunk-2MGLT2CN.js";import"./chunks/chunk-AGAJJR7S.js";import{b as x,d as $t,e as _t,f as vt,g as Et}from"./chunks/chunk-SJPKDO3M.js";var xt=x($t()),Tt=x(_t()),Mt=x(vt());var It=x(Et()),Ot=x(Pt());(function(){"use strict";let k=["natal","biwheel","solar"],J=window.AstroPreferences?.DEFAULT_ENABLED_ASPECT_TYPES||["Conjunction","Opposition","Trine","Square","Sextile","Vigintile","Semi_Nonagon","Semisextile","Decile","Nonagon","Semisquare","Quintile","Binonagon","Sentagon","Tridecile","Sesquiquadrate","Biquintile","Quincunx"],et={Sesquiquadrate:"⚼",Vigintile:"V",Semi_Nonagon:"SN",Decile:"D",Nonagon:"N",Binonagon:"BN",Sentagon:"SG",Tridecile:"TD",Septile:"7",Novile:"9"},H=window.AstroPreferences?.ORB_PROFILE_IDS||["natal","prognostic"],T=window.AstroPreferences?.DEFAULT_ORB_PAIR_STRATEGY||"larger",M="activePreferenceRecalcJobId",m=null,v=null,z=null,E=null,p="natal";function W(){if(window.AstroAPI?.hidePageLoader){window.AstroAPI.hidePageLoader();return}let t=document.getElementById("pageLoader");t&&(t.classList.add("fade-out"),setTimeout(()=>t.remove(),300))}function u(t,e){return window.FrontendI18n?.t?.(t,e)||t}function r(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function w(t,e=""){let o=u(t);return o&&o!==t?o:e}function g(t){return w(`astro.planet.${t}`,t)}function F(t){return window.Symbols?.planets?.[t]||String(t||"").slice(0,2)||"•"}function P(t){return w(`astro.aspect.${t}`,t)}function q(t){return window.Symbols?.aspects?.[t]||et[t]||String(t||"").slice(0,2)||"•"}function L(t){return w({harmonious:"page.chart.legend.harmonious",tense:"page.chart.legend.tense",neutral:"page.chart.legend.neutral"}[t],t)}function ot(t,e){return window.AstroPreferences?.deepEqual?window.AstroPreferences.deepEqual(t,e):JSON.stringify(t??null)===JSON.stringify(e??null)}function A(t={}){return window.AstroPreferences?.normalizeViewSettings?window.AstroPreferences.normalizeViewSettings(t):t}function h(t={}){return window.AstroPreferences?.normalizeMethodologySettings?window.AstroPreferences.normalizeMethodologySettings(t):t}function B(t={}){return window.AstroPreferences?.resolveVisualPreferences?window.AstroPreferences.resolveVisualPreferences(t):t||{}}function U(t={}){return window.AstroPreferences?.ensureMatrixRows?window.AstroPreferences.ensureMatrixRows(t||{}):t||{}}function at(){return window.AstroPreferences?.MATRIX_BODIES||[]}function $(){return v?.aspect_types||J.map(t=>({aspect_type:t}))}function nt(t){return $().find(e=>e?.aspect_type===t)||null}function st(t){return nt(t)?.character||window.AstroPreferences?.getAspectHarmonyType?.(t)||"neutral"}function I(){return(v?.bodies||[]).map(t=>t?.name).filter(Boolean)}function _(t="natal"){let e=$(),o=I();return window.AstroPreferences?.buildDefaultOrbProfileMatrix?window.AstroPreferences.buildDefaultOrbProfileMatrix(e,o,t):Object.fromEntries(e.map(n=>[n.aspect_type,Object.fromEntries(o.map(a=>[a,t==="prognostic"?a==="Moon"?3:1:Number(n.base_orb||5)]))]))}function S(){let t={version:2,pair_strategy:T,profiles:Object.fromEntries(H.map(e=>[e,{matrix:_(e)}]))};return h({orbs:t,balances:v?.default_balance_targets||{}})}function Y(){return B(v?.default_visual_palettes||{})}function G(){return{chart_defaults:{natal:A({}),biwheel:A({aspects:{scope:"major"}}),solar:A({})},chart_creation_defaults:{house_system:"P"},methodology:S(),visual:Y()}}function K(t){return t==="natal"?{orientation:document.getElementById("natalOrientationSelect"),aspectScope:document.getElementById("natalAspectScopeSelect"),showApplyingSeparating:document.getElementById("natalShowApplyingSeparating"),showSpeed:document.getElementById("natalShowSpeed"),showStationary:document.getElementById("natalShowStationary")}:t==="biwheel"?{orientation:document.getElementById("biwheelOrientationSelectAccount"),aspectScope:document.getElementById("biwheelAspectScopeSelectAccount"),showApplyingSeparating:null,showSpeed:null,showStationary:null}:{orientation:document.getElementById("solarOrientationSelectAccount"),aspectScope:document.getElementById("solarAspectScopeSelectAccount"),showApplyingSeparating:document.getElementById("solarShowApplyingSeparatingAccount"),showSpeed:document.getElementById("solarShowSpeedAccount"),showStationary:document.getElementById("solarShowStationaryAccount")}}function O(){return m||(m={methodology:S()}),m.methodology=h(m.methodology||S()),m.methodology}function ct(t){return O()?.orbs?.profiles?.[t]?.matrix||_(t)}function rt(){let t=document.getElementById("accountOrbPairStrategySelect");return t?window.AstroPreferences?.normalizeOrbPairStrategy?.(t.value)||T:h(m?.methodology||S())?.orbs?.pair_strategy||T}function Q(){let t=document.getElementById("accountOrbProfileHint"),e=document.getElementById("accountOrbMatrixPanel"),o=document.getElementById("accountApplyNatalOrbsBtn");document.querySelectorAll("[data-orb-profile-tab]").forEach(n=>{let a=n.dataset.orbProfileTab===p;n.classList.toggle("is-active",a),n.setAttribute("aria-selected",a?"true":"false"),e&&a&&n.id&&e.setAttribute("aria-labelledby",n.id)}),t&&(t.textContent=u(`page.accountSettings.orbs.hints.${p}`)),o&&o.classList.toggle("hidden",p!=="prognostic")}function R(){let t=O(),e=_(p);document.querySelectorAll("#accountOrbsMatrixBody input[data-orb-aspect-type][data-orb-body]").forEach(o=>{let n=o.dataset.orbAspectType,a=o.dataset.orbBody;!n||!a||(e[n]||(e[n]={}),e[n][a]=Number.parseFloat(o.value)||0)}),t.orbs.profiles[p]={matrix:e}}function lt(t,{rerender:e=!0}={}){H.includes(t)&&(m&&R(),p=t,Q(),e&&m&&D(m.methodology))}function it(t={}){let e=document.getElementById("accountAspectTypesMatrixBody");e&&(e.innerHTML=$().map(o=>{let n=o.aspect_type,a=r(q(n)),i=r(P(n)),c=k.map(s=>{let l=t?.[s]?.aspects?.enabled_types||[],y=new Set(Array.isArray(l)&&l.length?l:J).has(n)?"checked":"";return`
            ...
            `}).join(""))}function dt(t={}){let e=document.getElementById("accountBodiesMatrixBody");e&&(e.innerHTML=at().map(o=>{let n=r(g(o)),a=r(window.Symbols?.planets?.[o]||""),i=k.map(c=>{let s=U(t?.[c]?.matrix?.rows||{}),l=s?.[o]?.display!==!1?"checked":"",d=s?.[o]?.aspecting!==!1?"checked":"";return`
                    <td>
            ...
            `}).join(""))}function D(t={}){let e=document.getElementById("accountOrbsHeaderRow"),o=document.getElementById("accountOrbsMatrixBody");if(!e||!o)return;let n=I(),a=$(),c=h(t||S())?.orbs?.profiles?.[p]?.matrix||_(p);e.innerHTML=`
            <th class="account-settings-orb-corner"></th>
            ${n.map(s=>{let l=r(g(s)),d=r(window.Symbols?.planets?.[s]||s);return`
                    <th>
                        <span class="account-settings-body account-settings-body--icon-only">
        ...
        `,o.innerHTML=a.map(s=>{let l=s.aspect_type,d=r(q(l)),y=r(P(l));return`
                <tr>
                    ...
                    ${n.map(f=>{let tt=c?.[l]?.[f],Bt=r(g(f));return`
                            <td>
                                <input
            ...
            <tr>
                ...
                <td>
                    <button
                        ...
                        aria-label="${r(`${u("page.accountSettings.visual.actions.applyMatching")}: ${L(i)}`)}"
                    >⇢</button>
                </td>
            </tr>
