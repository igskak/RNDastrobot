                ...
                <tr>
                    <th scope="row">
                        <span class="account-settings-aspect-meta account-settings-aspect-meta--icon-only">
                            <span class="account-settings-check-glyph" title="${o}" aria-label="${o}" role="img" tabindex="0"><span class="astro-symbol" aria-hidden="true">${n}</span></span>
                        </span>
                    </th>
                    ${s}
                </tr>
                ...
                <tr>
                    <th scope="row">
                        <span class="account-settings-body account-settings-body--icon-only">
                            <span class="account-settings-body-badge" title="${n}" aria-label="${n}" role="img" tabindex="0"><span class="astro-symbol" aria-hidden="true">${o}</span></span>
                        </span>
                    </th>
                    ${s}
                </tr>
