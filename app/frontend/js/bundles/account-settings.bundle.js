import{a as et}from"./chunks/chunk-KRW4XNGY.js";import"./chunks/chunk-NLSSWA2H.js";import"./chunks/chunk-YBGVRB7X.js";import{b as R,d as Ke,e as Qe,f as Xe,g as Ze}from"./chunks/chunk-ORSN2CTV.js";var ot=R(Ke()),at=R(Qe()),st=R(Xe());var rt=R(Ze()),ct=R(et());(function(){"use strict";let J=["natal","biwheel","solar"],ee=window.AstroPreferences?.DEFAULT_ENABLED_ASPECT_TYPES||["Conjunction","Opposition","Trine","Square","Sextile","Vigintile","Semi_Nonagon","Semisextile","Decile","Nonagon","Semisquare","Quintile","Binonagon","Sentagon","Tridecile","Sesquiquadrate","Biquintile","Quincunx"],U=window.AstroPreferences?.ORB_PROFILE_IDS||["natal","prognostic"],F=window.AstroPreferences?.DEFAULT_ORB_PAIR_STRATEGY||"larger",Y="activePreferenceRecalcJobId",te="accountOrbViewMode",we=new Set(["TrueNode","SouthNode","BlackMoon","WhiteMoon","PartOfFortune","ASC","DSC","MC","IC","Vertex","AntiVertex"]),f=null,ne=null,h=null,oe=null,I=null,y="natal",C="default",q=null;function ae(){if(window.AstroAPI?.hidePageLoader){window.AstroAPI.hidePageLoader();return}let e=document.getElementById("pageLoader");e&&(e.classList.add("fade-out"),setTimeout(()=>e.remove(),460))}function b(e,n){return window.FrontendI18n?.t?.(e,n)||e}function r(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function $(e,n=""){let t=b(e);return t&&t!==e?t:n}function g(e){return $(`astro.planet.${e}`,window.Symbols?.getPlanetNameRu?.(e)||e)}function se(e){return window.Symbols?.getPlanetSymbol?.(e)||String(e||"").slice(0,2)||"•"}function L(e,n={}){return window.Symbols?.getPlanetSymbolMarkup?.(e,n)||`<span class="astro-symbol" aria-hidden="true">${r(se(e))}</span>`}function _e(e){let n=window.AstroPreferences?.normalizeMatrixBodyName?window.AstroPreferences.normalizeMatrixBodyName(e):e,t=h?.default_dignities?.signs||{},o=window.Symbols?.signElements||{},s=V().map(a=>a?.name).filter(Boolean),i=s.length?s:Object.keys(t);for(let a of i)if(t?.[a]?.ruler===n)return o[a]||null;for(let a of i)if(t?.[a]?.co_ruler===n)return o[a]||null;for(let a of i)if(t?.[a]?.exaltation===n)return o[a]||null;return null}function Ae(e,n={}){let t=x(n),o=_e(e);return window.AstroPreferences?.getPlanetColor?window.AstroPreferences.getPlanetColor(e,o,t):window.AstroPreferences?.getElementColor?window.AstroPreferences.getElementColor(o,t):"#6b7280"}function O(e){return $(`astro.aspect.${e}`,e)}function G(e){return window.Symbols?.getAspectDisplay?.(e)||window.Symbols?.aspects?.[e]||String(e||"").slice(0,3)||"•"}function Ee(e,n){return window.AstroPreferences?.deepEqual?window.AstroPreferences.deepEqual(e,n):JSON.stringify(e??null)===JSON.stringify(n??null)}function Be(e){return e==null?e:JSON.parse(JSON.stringify(e))}function P(e={}){return window.AstroPreferences?.normalizeViewSettings?window.AstroPreferences.normalizeViewSettings(e):e}function _(e={}){return window.AstroPreferences?.normalizeMethodologySettings?window.AstroPreferences.normalizeMethodologySettings(e):e}function D(e={},n={}){return window.AstroPreferences?.normalizeDignitySettings?window.AstroPreferences.normalizeDignitySettings(e,n):e}function x(e={}){return window.AstroPreferences?.resolveVisualPreferences?window.AstroPreferences.resolveVisualPreferences(e):e||{}}function ie(e={}){return window.AstroPreferences?.ensureMatrixRows?window.AstroPreferences.ensureMatrixRows(e||{}):e||{}}function ve(){return window.AstroPreferences?.MATRIX_BODIES||[]}function M(){return h?.aspect_types||ee.map(e=>({aspect_type:e}))}function tt(e){return M().find(n=>n?.aspect_type===e)||null}function k(){return(h?.bodies||[]).map(e=>e?.name).filter(Boolean)}function V(){return h?.signs||[]}function re(){return k().filter(e=>!we.has(e))}function T(e="natal"){let n=M(),t=k();return window.AstroPreferences?.buildDefaultOrbProfileMatrix?window.AstroPreferences.buildDefaultOrbProfileMatrix(n,t,e):Object.fromEntries(n.map(o=>[o.aspect_type,Object.fromEntries(t.map(s=>[s,e==="prognostic"?s==="Moon"?3:1:Number(o.base_orb||5)]))]))}function v(){let e={version:2,pair_strategy:F,profiles:Object.fromEntries(U.map(n=>[n,{matrix:T(n)}]))};return _({orbs:e,balances:h?.default_balance_targets||{},dignities:h?.default_dignities||{version:1,signs:{}}})}function ce(){return x(h?.default_visual_palettes||{})}function le(){return{chart_defaults:{natal:P({}),biwheel:P({aspects:{scope:"major"}}),solar:P({})},chart_creation_defaults:{house_system:"P"},methodology:v(),visual:ce()}}function de(){return document.getElementById("accountTimezoneLabelFormatSelect")}function ue(){return document.getElementById("accountDateFormatSelect")}function me(){return document.getElementById("accountDegreeFormatSelect")}function ge(e){return e==="natal"?{orientation:document.getElementById("natalOrientationSelect"),aspectScope:document.getElementById("natalAspectScopeSelect"),showApplyingSeparating:document.getElementById("natalShowApplyingSeparating"),showSpeed:document.getElementById("natalShowSpeed"),showStationary:document.getElementById("natalShowStationary"),showAspectText:document.getElementById("natalShowAspectText")}:e==="biwheel"?{orientation:document.getElementById("biwheelOrientationSelectAccount"),aspectScope:document.getElementById("biwheelAspectScopeSelectAccount"),showApplyingSeparating:null,showSpeed:null,showStationary:null,showAspectText:document.getElementById("biwheelShowAspectTextAccount")}:{orientation:document.getElementById("solarOrientationSelectAccount"),aspectScope:document.getElementById("solarAspectScopeSelectAccount"),showApplyingSeparating:document.getElementById("solarShowApplyingSeparatingAccount"),showSpeed:document.getElementById("solarShowSpeedAccount"),showStationary:document.getElementById("solarShowStationaryAccount"),showAspectText:document.getElementById("solarShowAspectTextAccount")}}function A(){return f||(f={methodology:v()}),f.methodology=_(f.methodology||v()),f.methodology}function $e(e){return A()?.orbs?.profiles?.[e]?.matrix||T(e)}function Pe(){let e=document.getElementById("accountOrbPairStrategySelect");return e?window.AstroPreferences?.normalizeOrbPairStrategy?.(e.value)||F:_(f?.methodology||v())?.orbs?.pair_strategy||F}function pe(e){return $(`astro.sign.${e}`,window.Symbols?.signNamesRu?.[e]||e)}function xe(e){return window.Symbols?.signs?.[e]||String(e||"").slice(0,2)||"•"}function Me(e){let n=r(pe(e)),t=r(xe(e));return`<span class="astro-symbol" aria-hidden="true" title="${n}">${t}</span>`}function nt(e){return V().find(n=>n?.name===e)?.opposite||null}function W(){let e=A();return e.dignities=D(e.dignities||{},h?.default_dignities||{}),e.dignities}function Te(e={}){let n=re(),t=Object.fromEntries(n.map(o=>[o,{domicile_primary:[],domicile_secondary:[],detriment_primary:[],detriment_secondary:[],exaltation:[],fall:[]}]));return V().forEach(o=>{let s=o?.name,i=o?.opposite,a=e?.signs?.[s]||{};a.ruler&&t[a.ruler]&&(t[a.ruler].domicile_primary.push(s),i&&t[a.ruler].detriment_primary.push(i)),a.co_ruler&&t[a.co_ruler]&&(t[a.co_ruler].domicile_secondary.push(s),i&&t[a.co_ruler].detriment_secondary.push(i)),a.exaltation&&t[a.exaltation]&&(t[a.exaltation].exaltation.push(s),i&&t[a.exaltation].fall.push(i))}),t}function z(e=[],{mode:n="derived",secondarySigns:t=[]}={}){let o=new Set(t||[]);return V().map(s=>{let i=s?.name,a=e.includes(i)||o.has(i),d=o.has(i),u=["account-settings-dignity-glyph",a?"is-active":"",d?"is-secondary":"",n==="derived"?"is-derived":""].filter(Boolean).join(" "),c=r(pe(i)),l=r(`${c} · ${b(a?d?"page.accountSettings.dignities.states.secondary":"page.accountSettings.dignities.states.primary":"page.accountSettings.dignities.states.empty")}`);return`
                <button
                    ...
                    ${n==="derived"?"disabled":""}
                >${Me(i)}</button>
            `}).join("")}function ye(){let e=document.getElementById("accountOrbProfileHint"),n=document.getElementById("accountOrbMatrixPanel"),t=document.getElementById("accountApplyNatalOrbsBtn");document.querySelectorAll("[data-orb-profile-tab]").forEach(o=>{let s=o.dataset.orbProfileTab===y;o.classList.toggle("is-active",s),o.setAttribute("aria-selected",s?"true":"false"),n&&s&&o.id&&n.setAttribute("aria-labelledby",o.id)}),e&&(e.textContent=b(`page.accountSettings.orbs.hints.${y}`)),t&&t.classList.toggle("hidden",y!=="prognostic")}function fe(){let e=document.getElementById("accountOrbMatrixPanel"),n=document.getElementById("accountOrbsTable");document.querySelectorAll("[data-orb-view-mode]").forEach(t=>{let o=t.dataset.orbViewMode===C;t.classList.toggle("is-active",o),t.setAttribute("aria-selected",o?"true":"false")}),e?.classList.toggle("is-compact",C==="compact"),n?.classList.toggle("is-compact",C==="compact")}function K(){let e=A(),n=T(y);document.querySelectorAll("#accountOrbsMatrixBody input[data-orb-aspect-type][data-orb-body]").forEach(t=>{let o=t.dataset.orbAspectType,s=t.dataset.orbBody;!o||!s||(n[o]||(n[o]={}),n[o][s]=Number.parseFloat(t.value)||0)}),e.orbs.profiles[y]={matrix:n}}function Ie(e,{rerender:n=!0}={}){U.includes(e)&&(f&&K(),y=e,ye(),n&&f&&Q(f.methodology))}function Ce(e){["default","compact"].includes(e)&&(C=e,localStorage.setItem(te,e),fe())}function Le(e={}){let n=document.getElementById("accountAspectTypesMatrixBody");n&&(n.innerHTML=M().map(t=>{let o=t.aspect_type,s=r(G(o)),i=r(O(o)),a=J.map(d=>{let u=e?.[d]?.aspects?.enabled_types||[],p=new Set(Array.isArray(u)&&u.length?u:ee).has(o)?"checked":"";return`
                    <td>
            ...
            `}).join(""))}function Oe(e={}){let n=document.getElementById("accountBodiesMatrixBody");n&&(n.innerHTML=ve().map(t=>{let o=r(g(t)),s=L(t,{size:18,title:g(t)}),i=J.map(a=>{let d=ie(e?.[a]?.matrix?.rows||{}),u=d?.[t]?.display!==!1?"checked":"",c=d?.[t]?.aspecting!==!1?"checked":"";return`
                    <td>
            ...
            `}).join(""))}function Q(e={}){let n=document.getElementById("accountOrbsHeaderRow"),t=document.getElementById("accountOrbsMatrixBody");if(!n||!t)return;let o=k(),s=M(),a=_(e||v())?.orbs?.profiles?.[y]?.matrix||T(y);n.innerHTML=`
        ...
        `,t.innerHTML=s.map(d=>{let u=d.aspect_type,c=r(G(u)),p=r(O(u));return`
            ...
            `}).join(""),ye(),fe()}function be(e={}){let n=document.getElementById("accountDignitiesMatrixBody");if(!n)return;let t=D(e?.dignities||{},h?.default_dignities||{}),o=Te(t);n.innerHTML=re().map(s=>{let i=r(g(s)),a=o[s]||{domicile_primary:[],domicile_secondary:[],detriment_primary:[],detriment_secondary:[],exaltation:[],fall:[]};return`
                <tr>
            ...
            `}).join("")}function De(e,n){let t=W(),o={...t.signs?.[e]||{}};o.ruler===n?o.co_ruler?(o.ruler=o.co_ruler,o.co_ruler=null):o.ruler=null:o.co_ruler===n?o.co_ruler=null:o.ruler?o.co_ruler=n:o.ruler=n,t.signs[e]=o,A().dignities=D(t,h?.default_dignities||{})}function ke(e,n){let t=W(),o={...t.signs?.[e]||{}};o.exaltation=o.exaltation===n?null:n,t.signs[e]=o,A().dignities=D(t,h?.default_dignities||{})}function Ne(e={}){let n=document.getElementById("accountBalancePlanetWeightsBody"),t=document.getElementById("accountBalanceSpecialWeightsBody");if(!n||!t)return;let o=e?.balances||{},s=o?.planet_weights||{},i=o?.special_point_weights||{},d=k().filter(c=>!["TrueNode","SouthNode","BlackMoon","WhiteMoon","PartOfFortune","ASC","DSC","MC","IC","Vertex","AntiVertex"].includes(c)),u=["TrueNorthNode","TrueSouthNode","BlackMoon"];n.innerHTML=d.map(c=>`
            <tr>
                <th scope="row" class="account-settings-icon-cell">
                        <span class="account-settings-body account-settings-body--icon-only">
        ...
        `).join("")}function Re(e={}){let n=document.getElementById("accountAspectColorsBody");if(!n)return;let t=x(e);n.innerHTML=M().map(o=>{let s=o.aspect_type,i=window.AstroPreferences?.getAspectColor?window.AstroPreferences.getAspectColor(s,t):"#9ca3af";return`
                <tr>
                    <th scope="row" class="account-settings-icon-cell">
                        <span class="account-settings-aspect-meta account-settings-aspect-meta--icon-only">
            ...
            `}).join("")}function Fe(e={}){let n=document.getElementById("accountElementPaletteBody"),t=document.getElementById("accountBodyOverrideColorsBody");if(!n||!t)return;let o=x(e),s=o?.planet_colors?.element_palette||{},i=o?.planet_colors?.body_overrides||{};n.innerHTML=Object.keys(s).map(a=>`
            <tr>
                <th scope="row">${r(a)}</th>
        ...
        `).join(""),t.innerHTML=k().map(a=>{let d=Ae(a,o),u=!!i?.[a],c=i?.[a]||d;return`
                <tr>
                    <th scope="row" class="account-settings-icon-cell">
                        <span class="account-settings-body account-settings-body--icon-only">
        ...
        `,t.classList.remove("hidden"),t.dataset.status=a}function Z(){I&&(clearTimeout(I),I=null)}async function Se(e){if(Z(),!e||!window.AstroAPI?.getPreferenceRecalcJob)return;sessionStorage.setItem(Y,String(e));let n=async()=>{try{let t=await window.AstroAPI.getPreferenceRecalcJob(e);if(H(t,{final:t.status==="completed"||t.status==="failed"}),t.status==="completed"){sessionStorage.removeItem(Y),E(t.failed_count?`Пересчет завершен с ошибками: ${t.failed_count}.`:"Пересчет карт завершен.",t.failed_count?"info":"success"),await He(),Z();return}if(t.status==="failed"){sessionStorage.removeItem(Y),E(t.error||"Пересчет карт не выполнен.","error"),Z();return}I=setTimeout(n,2500)}catch(t){I=setTimeout(n,4e3),console.warn("Failed to poll preference recalculation job:",t)}};await n()}async function Je(){let e=await window.AstroAPI?.requireAuth?.({redirectTo:"/login.html"});if(!e)return;let n=document.getElementById("accountSettingsSubtitle");n&&(n.textContent=e.email?b("page.accountSettings.subtitleWithEmail",{email:e.email}):b("page.accountSettings.subtitle"));let[t,o]=await Promise.all([window.AstroAPI.getPreferencesMetadata?.(),window.AstroAPI.getAccountPreferences()]);h=t||null,j(o,{updateBaseline:!0});let s=sessionStorage.getItem(Y);s?Se(s).catch(i=>{console.warn("Failed to resume recalculation job polling:",i)}):H(null),ae()}async function Ue(){let e=document.getElementById("saveAccountSettingsBtn");e&&(e.disabled=!0);try{let n=je(),t=localStorage.getItem("currentUserId")||null,o=!Ee(_(ne||{}),n.methodology),s=await window.AstroAPI.patchAccountPreferences(n);if(j(s,{updateBaseline:!0}),o&&window.AstroAPI?.createPreferenceRecalcJob){let i=await window.AstroAPI.createPreferenceRecalcJob({job_type:"methodology_recalc",payload:{source:"account-settings",...t?{priority_user_id:t}:{}}});H(i),Se(i.job_id).catch(a=>{console.warn("Failed to poll methodology recalculation job:",a)}),E("Настройки сохранены. Карты пересчитываются с учетом новых настроек.","success"),requestAnimationFrame(he);return}E(b("page.accountSettings.toasts.saved"),"success"),requestAnimationFrame(he)}catch(n){E(n.message||b("page.accountSettings.toasts.saveFailed"),"error")}finally{e&&(e.disabled=!1)}}function Ge(){j(le()),H(null),E(b("page.accountSettings.toasts.restored"),"info")}function N({restoreFocus:e=!0}={}){let n=document.getElementById("accountSettingsResetConfirmDialog"),t=document.getElementById("accountSettingsResetConfirmBackdrop");n&&n.classList.add("hidden"),t&&t.classList.add("hidden"),document.body.classList.remove("account-settings-modal-open"),e&&q instanceof HTMLElement&&q.focus(),q=null}function We(){let e=document.getElementById("accountSettingsResetConfirmDialog"),n=document.getElementById("accountSettingsResetConfirmBackdrop"),t=document.getElementById("accountSettingsResetConfirmSubmit");!e||!n||(q=document.activeElement instanceof HTMLElement?document.activeElement:null,n.classList.remove("hidden"),e.classList.remove("hidden"),document.body.classList.add("account-settings-modal-open"),requestAnimationFrame(()=>{t?.focus()}))}document.addEventListener("DOMContentLoaded",async()=>{C=localStorage.getItem(te)==="compact"?"compact":"default";let e=document.getElementById("saveAccountSettingsBtn"),n=document.getElementById("restoreStandardDefaultsBtn"),t=document.getElementById("accountApplyNatalOrbsBtn"),o=document.getElementById("accountOrbsMatrixBody"),s=document.getElementById("accountDignitiesMatrixBody"),i=document.getElementById("accountBodyOverrideColorsBody"),a=document.getElementById("accountSettingsResetConfirmDialog"),d=document.getElementById("accountSettingsResetConfirmBackdrop"),u=document.getElementById("accountSettingsResetConfirmClose"),c=document.getElementById("accountSettingsResetConfirmCancel"),p=document.getElementById("accountSettingsResetConfirmSubmit");e?.addEventListener("click",()=>{Ue()}),n?.addEventListener("click",()=>{We()}),d?.addEventListener("click",()=>{N()}),u?.addEventListener("click",()=>{N()}),c?.addEventListener("click",()=>{N()}),p?.addEventListener("click",()=>{N({restoreFocus:!1}),Ge()}),document.querySelectorAll("[data-orb-profile-tab]").forEach(l=>{l.addEventListener("click",()=>{Ie(l.dataset.orbProfileTab||"natal")})}),document.querySelectorAll("[data-orb-view-mode]").forEach(l=>{l.addEventListener("click",()=>{Ce(l.dataset.orbViewMode||"default")})}),t?.addEventListener("click",()=>{K();let l=A();l.orbs.profiles.prognostic={matrix:JSON.parse(JSON.stringify($e("natal")))},y="prognostic",Q(l),E(b("page.accountSettings.toasts.orbsCopied"),"info")}),o?.addEventListener("input",l=>{let m=l.target;if(!(m instanceof HTMLInputElement)||!m.dataset.orbAspectType||!m.dataset.orbBody)return;let S=A(),B=(S.orbs.profiles[y]||{matrix:T(y)}).matrix||T(y);B[m.dataset.orbAspectType]||(B[m.dataset.orbAspectType]={}),B[m.dataset.orbAspectType][m.dataset.orbBody]=Number.parseFloat(m.value)||0,S.orbs.profiles[y]={matrix:B}}),s?.addEventListener("click",l=>{let m=l.target.closest("[data-dignity-mode][data-dignity-sign]");if(!(m instanceof HTMLButtonElement))return;let S=m.dataset.dignityMode,w=m.dataset.dignitySign,B=m.closest("[data-dignity-planet]")?.dataset?.dignityPlanet;!S||!w||!B||S==="derived"||(S==="domicile"?De(w,B):S==="exaltation"&&ke(w,B),be(f?.methodology||A()))}),i?.addEventListener("input",l=>{let m=l.target;if(!(m instanceof HTMLInputElement)||!m.dataset.bodyColorOverride)return;m.dataset.bodyColorActive="true",i.querySelector(`[data-clear-body-color-override="${m.dataset.bodyColorOverride}"]`)?.classList.remove("is-muted")}),i?.addEventListener("click",l=>{let m=l.target.closest("[data-clear-body-color-override]");if(!(m instanceof HTMLElement))return;let S=m.dataset.clearBodyColorOverride;if(!S)return;let w=i.querySelector(`[data-body-color-override="${S}"]`);w instanceof HTMLInputElement&&(w.dataset.bodyColorActive="false",w.value=w.dataset.bodyColorDefault||"#6b7280",m.classList.add("is-muted"))});try{await window.FrontendI18n?.ready?.catch?.(()=>{}),await Je(),document.addEventListener("frontend:locale-changed",()=>{f&&j(f)}),document.addEventListener("keydown",l=>{l.key==="Escape"&&(!a||a.classList.contains("hidden")||N())})}catch(l){E(l.message||b("page.accountSettings.toasts.loadFailed"),"error"),ae()}})})();
