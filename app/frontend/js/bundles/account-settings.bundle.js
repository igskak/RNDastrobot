import{a as bt}from"./chunks/chunk-2N23K522.js";import"./chunks/chunk-SYPQTWEU.js";import"./chunks/chunk-XCJV446S.js";import{a as ht}from"./chunks/chunk-D4GN5UHL.js";import"./chunks/chunk-MZ7NETWD.js";import{a as yt}from"./chunks/chunk-GWDPXEZM.js";import{b as O,d as mt,e as pt,f as ft}from"./chunks/chunk-BI736Q2H.js";var Et=O(mt()),At=O(pt()),Bt=O(ft());var Pt=O(yt()),xt=O(ht()),$t=O(bt());(function(){"use strict";let Z=["natal","biwheel","solar"],Ce=["aspectColors","elementPalette","bodyOverrides","wheel"],Le=["Conjunction","Trine","Square","Opposition","Sextile"],Me={Sun:"Fire",Moon:"Water",Mercury:"Air",Venus:"Earth",Mars:"Fire",Jupiter:"Fire"},ce=window.AstroPreferences?.DEFAULT_ENABLED_ASPECT_TYPES||["Conjunction","Opposition","Trine","Square","Sextile","Vigintile","Semi_Nonagon","Semisextile","Decile","Nonagon","Semisquare","Quintile","Binonagon","Sentagon","Tridecile","Sesquiquadrate","Biquintile","Quincunx"],ee=window.AstroPreferences?.ORB_PROFILE_IDS||["natal","prognostic","synastry"],j=window.AstroPreferences?.DEFAULT_ORB_PAIR_STRATEGY||"larger",U="activePreferenceRecalcJobId",re="accountOrbViewMode",Oe=new Set(["TrueNode","SouthNode","BlackMoon","WhiteMoon","PartOfFortune","ASC","DSC","MC","IC","Vertex","AntiVertex"]),h=null,ie=null,_=null,le=null,k=null,y="natal",D="default",J="aspectColors",W=null;function de(){if(window.AstroAPI?.hidePageLoader){window.AstroAPI.hidePageLoader();return}let e=document.getElementById("pageLoader");e&&(e.classList.add("fade-out"),setTimeout(()=>e.remove(),460))}function m(e,t){return window.FrontendI18n?.t?.(e,t)||e}function ke(){let e=document.querySelector(".account-settings-back");if(!e)return;let t=window.AstroAPI?.getNavigationState?.()||{},n="";try{let o=document.referrer?new URL(document.referrer):null;o&&o.origin===window.location.origin&&!o.pathname.endsWith("/account-settings.html")&&(n=`${o.pathname}${o.search||""}${o.hash||""}`)}catch{n=""}e.href=n||window.AstroAPI?.getAccountSettingsReturnUrl?.()||t.sourceUrl||"/"}function i(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function I(e,t=""){let n=m(e);return n&&n!==e?n:t}function De(e){return window.AstroPlan?.getPlanCode?.(e)||String(e?.plan_code||"pro").trim().toLowerCase()||"pro"}function Ne(e){let t=window.AstroPlan?.getSavedChartLimitState?.(e);return!t||t.max===null||t.max===void 0?m("page.plan.usage.savedChartsUnlimited",{current:t?.current||0}):m("page.plan.usage.savedChartsLimited",{current:t.current,max:t.max})}function ue(e){if(!e)return"";if(window.LocaleFormatters?.formatDate)return window.LocaleFormatters.formatDate(e);let t=new Date(e);return Number.isNaN(t.getTime())?String(e):t.toLocaleDateString()}function Re(e){let t=e?.billing?.subscription;return t?t.cancel_at_period_end&&t.current_period_end?m("page.accountSettings.plan.billingCancelsAt",{date:ue(t.current_period_end)}):t.current_period_end?m("page.accountSettings.plan.billingRenewsAt",{date:ue(t.current_period_end)}):m(`page.accountSettings.plan.billingStatus.${t.status}`)||t.status:m("page.accountSettings.plan.billingFree")}function Fe(e){let t=document.getElementById("accountPlanCard");if(!t)return;let n=window.AstroAPI?.isSoloPlan?.(e)===!0;if(t.classList.toggle("hidden",n),n)return;let o=De(e),a=document.getElementById("accountPlanTitle"),c=document.getElementById("accountPlanCopy"),s=document.getElementById("accountPlanUsage"),l=document.getElementById("accountPlanBillingStatus"),r=document.getElementById("accountPlanPortalBtn");if(a&&(a.textContent=m(`page.plan.names.${o}`)),c&&(c.textContent=m(`page.plan.descriptions.${o}`)),s&&(s.textContent=Ne(e)),l&&(l.textContent=Re(e)),r){let d=!!e?.billing?.subscription;r.classList.toggle("hidden",!d),r.onclick=async()=>{try{r.disabled=!0;let p=await window.AstroAPI.getBillingPortal();p?.portal_url&&(window.location.href=p.portal_url)}catch(p){B(p.message||m("page.plan.modal.errors.portalFailed"),"error")}finally{r.disabled=!1}}}t.dataset.planCode=o}function f(e){return I(`astro.planet.${e}`,window.Symbols?.getPlanetNameRu?.(e)||e)}function ge(e){return window.Symbols?.getPlanetSymbol?.(e)||String(e||"").slice(0,2)||"•"}function N(e,t={}){return window.Symbols?.getPlanetSymbolMarkup?.(e,t)||`<span class="astro-symbol" aria-hidden="true">${i(ge(e))}</span>`}function Ve(e){let t=window.AstroPreferences?.normalizeMatrixBodyName?window.AstroPreferences.normalizeMatrixBodyName(e):e,n=_?.default_dignities?.signs||{},o=window.Symbols?.signElements||{},a=G().map(s=>s?.name).filter(Boolean),c=a.length?a:Object.keys(n);for(let s of c)if(n?.[s]?.ruler===t)return o[s]||null;for(let s of c)if(n?.[s]?.co_ruler===t)return o[s]||null;for(let s of c)if(n?.[s]?.exaltation===t)return o[s]||null;return null}function me(e,t={}){let n=$(t),o=Ve(e);return window.AstroPreferences?.getPlanetColor?window.AstroPreferences.getPlanetColor(e,o,n):window.AstroPreferences?.getElementColor?window.AstroPreferences.getElementColor(o,n):"#6b7280"}function R(e){return I(`astro.aspect.${e}`,e)}function te(e){return window.Symbols?.getAspectDisplay?.(e)||window.Symbols?.aspects?.[e]||String(e||"").slice(0,3)||"•"}function He(e,t){return window.AstroPreferences?.deepEqual?window.AstroPreferences.deepEqual(e,t):JSON.stringify(e??null)===JSON.stringify(t??null)}function F(e){return e==null?e:JSON.parse(JSON.stringify(e))}function v(e={}){return window.AstroPreferences?.normalizeViewSettings?window.AstroPreferences.normalizeViewSettings(e):e}function P(e={}){return window.AstroPreferences?.normalizeMethodologySettings?window.AstroPreferences.normalizeMethodologySettings(e):e}function V(e={},t={}){return window.AstroPreferences?.normalizeDignitySettings?window.AstroPreferences.normalizeDignitySettings(e,t):e}function $(e={}){return window.AstroPreferences?.resolveVisualPreferences?window.AstroPreferences.resolveVisualPreferences(e):e||{}}function pe(e={}){return window.AstroPreferences?.ensureMatrixRows?window.AstroPreferences.ensureMatrixRows(e||{}):e||{}}function qe(){return window.AstroPreferences?.MATRIX_BODIES||[]}function C(){return _?.aspect_types||ce.map(e=>({aspect_type:e}))}function St(e){return C().find(t=>t?.aspect_type===e)||null}function H(){return(_?.bodies||[]).map(e=>e?.name).filter(Boolean)}function G(){return _?.signs||[]}function fe(){return H().filter(e=>!Oe.has(e))}function L(e="natal"){let t=C(),n=H();return window.AstroPreferences?.buildDefaultOrbProfileMatrix?window.AstroPreferences.buildDefaultOrbProfileMatrix(t,n,e):Object.fromEntries(t.map(o=>[o.aspect_type,Object.fromEntries(n.map(a=>[a,e==="prognostic"?a==="Moon"?3:1:Number(o.base_orb||5)]))]))}function T(){let e={version:2,pair_strategy:j,profiles:Object.fromEntries(ee.map(t=>[t,{matrix:L(t)}]))};return P({orbs:e,balances:_?.default_balance_targets||{},dignities:_?.default_dignities||{version:1,signs:{}}})}function ye(){return $(_?.default_visual_palettes||{})}function he(){return{chart_defaults:{natal:v({}),biwheel:v({}),forecast_new:v({}),solar:v({})},chart_creation_defaults:{house_system:"P"},methodology:T(),visual:ye()}}function be(){return document.getElementById("accountTimezoneLabelFormatSelect")}function Se(){return document.getElementById("accountDateFormatSelect")}function we(){return document.getElementById("accountDegreeFormatSelect")}function _e(e){return e==="natal"?{orientation:document.getElementById("natalOrientationSelect"),aspectScope:document.getElementById("natalAspectScopeSelect"),showApplyingSeparating:document.getElementById("natalShowApplyingSeparating"),showSpeed:document.getElementById("natalShowSpeed"),showStationary:document.getElementById("natalShowStationary"),showAspectText:document.getElementById("natalShowAspectText")}:e==="biwheel"?{orientation:document.getElementById("biwheelOrientationSelectAccount"),aspectScope:document.getElementById("biwheelAspectScopeSelectAccount"),showApplyingSeparating:null,showSpeed:null,showStationary:null,showAspectText:document.getElementById("biwheelShowAspectTextAccount")}:{orientation:document.getElementById("solarOrientationSelectAccount"),aspectScope:document.getElementById("solarAspectScopeSelectAccount"),showApplyingSeparating:document.getElementById("solarShowApplyingSeparatingAccount"),showSpeed:document.getElementById("solarShowSpeedAccount"),showStationary:document.getElementById("solarShowStationaryAccount"),showAspectText:document.getElementById("solarShowAspectTextAccount")}}function x(){return h||(h={methodology:T()}),h.methodology=P(h.methodology||T()),h.methodology}function Ye(e){return x()?.orbs?.profiles?.[e]?.matrix||L(e)}function ze(){let e=document.getElementById("accountOrbPairStrategySelect");return e?window.AstroPreferences?.normalizeOrbPairStrategy?.(e.value)||j:P(h?.methodology||T())?.orbs?.pair_strategy||j}function Ee(e){return I(`astro.sign.${e}`,window.Symbols?.signNamesRu?.[e]||e)}function je(e){return window.Symbols?.signs?.[e]||String(e||"").slice(0,2)||"•"}function Ue(e){let t=i(Ee(e)),n=i(je(e));return`<span class="astro-symbol" aria-hidden="true" title="${t}">${n}</span>`}function wt(e){return G().find(t=>t?.name===e)?.opposite||null}function ne(){let e=x();return e.dignities=V(e.dignities||{},_?.default_dignities||{}),e.dignities}function Je(e={}){let t=fe(),n=Object.fromEntries(t.map(o=>[o,{domicile_primary:[],domicile_secondary:[],detriment_primary:[],detriment_secondary:[],exaltation:[],fall:[]}]));return G().forEach(o=>{let a=o?.name,c=o?.opposite,s=e?.signs?.[a]||{};s.ruler&&n[s.ruler]&&(n[s.ruler].domicile_primary.push(a),c&&n[s.ruler].detriment_primary.push(c)),s.co_ruler&&n[s.co_ruler]&&(n[s.co_ruler].domicile_secondary.push(a),c&&n[s.co_ruler].detriment_secondary.push(c)),s.exaltation&&n[s.exaltation]&&(n[s.exaltation].exaltation.push(a),c&&n[s.exaltation].fall.push(c))}),n}function K(e=[],{mode:t="derived",secondarySigns:n=[]}={}){let o=new Set(n||[]);return G().map(a=>{let c=a?.name,s=e.includes(c)||o.has(c),l=o.has(c),r=["account-settings-dignity-glyph",s?"is-active":"",l?"is-secondary":"",t==="derived"?"is-derived":""].filter(Boolean).join(" "),d=i(Ee(c)),S=i(`${d} · ${m(s?l?"page.accountSettings.dignities.states.secondary":"page.accountSettings.dignities.states.primary":"page.accountSettings.dignities.states.empty")}`);return`
                <button
                    ...
                    ${t==="derived"?"disabled":""}
                >${Ue(c)}</button>
            `}).join("")}function Ae(){let e=document.getElementById("accountOrbProfileHint"),t=document.getElementById("accountOrbMatrixPanel"),n=document.getElementById("accountApplyNatalOrbsBtn");document.querySelectorAll("[data-orb-profile-tab]").forEach(o=>{let a=o.dataset.orbProfileTab===y;o.classList.toggle("is-active",a),o.setAttribute("aria-selected",a?"true":"false"),t&&a&&o.id&&t.setAttribute("aria-labelledby",o.id)}),e&&(e.textContent=m(`page.accountSettings.orbs.hints.${y}`)),n&&n.classList.toggle("hidden",y==="natal")}function Be(){let e=document.getElementById("accountOrbMatrixPanel"),t=document.getElementById("accountOrbsTable");document.querySelectorAll("[data-orb-view-mode]").forEach(n=>{let o=n.dataset.orbViewMode===D;n.classList.toggle("is-active",o),n.setAttribute("aria-selected",o?"true":"false")}),e?.classList.toggle("is-compact",D==="compact"),t?.classList.toggle("is-compact",D==="compact")}function ve(e){Ce.includes(e)&&(J=e,document.querySelectorAll("[data-visual-tab]").forEach(t=>{let n=t.dataset.visualTab===J;t.classList.toggle("is-active",n),t.setAttribute("aria-selected",n?"true":"false")}),document.querySelectorAll("[data-visual-panel]").forEach(t=>{t.classList.toggle("hidden",t.dataset.visualPanel!==J)}))}function Pe(e){return String(e||"").trim().replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function xe(e,t,n,o="#6b7280"){let a=String(n||o).trim();e.style.setProperty(t,/^#[0-9a-f]{6}$/i.test(a)?a:o)}function q(e={}){let t=document.getElementById("accountVisualWheelPreview");if(!t)return;let n=$(e),o=n?.planet_colors?.element_palette||{},a=n?.planet_colors?.body_overrides||{};Le.forEach(c=>{let s=window.AstroPreferences?.getAspectColor?window.AstroPreferences.getAspectColor(c,n):n?.aspect_colors?.[c];xe(t,`--preview-aspect-${Pe(c)}`,s)}),Object.entries(Me).forEach(([c,s])=>{let l=a?.[c]||o?.[s]||me(c,n);xe(t,`--preview-body-${Pe(c)}`,l)}),t.style.setProperty("--preview-cusp",n?.wheel?.angular_cusps_black===!0?"#111827":"#8d6f54"),t.style.setProperty("--preview-line-width",n?.wheel?.highlight_exact_aspects===!1?"1.5px":"2.5px")}function oe(){let e=x(),t=L(y);document.querySelectorAll("#accountOrbsMatrixBody input[data-orb-aspect-type][data-orb-body]").forEach(n=>{let o=n.dataset.orbAspectType,a=n.dataset.orbBody;!o||!a||(t[o]||(t[o]={}),t[o][a]=Number.parseFloat(n.value)||0)}),e.orbs.profiles[y]={matrix:t}}function We(e,{rerender:t=!0}={}){ee.includes(e)&&(h&&oe(),y=e,Ae(),t&&h&&ae(h.methodology))}function Ge(e){["default","compact"].includes(e)&&(D=e,localStorage.setItem(re,e),Be())}function Ke(e={}){let t=document.getElementById("accountAspectTypesMatrixBody");t&&(t.innerHTML=C().map(n=>{let o=n.aspect_type,a=i(te(o)),c=i(R(o)),s=Z.map(l=>{let r=e?.[l]?.aspects?.enabled_types||[],p=new Set(Array.isArray(r)&&r.length?r:ce).has(o)?"checked":"";return`
                    <td>
                        <label class="account-settings-aspect-cell">
                            <input
                                ...
                                data-aspect-type="${o}"
                                ${p}
                                aria-label="${i(`${I(`page.accountSettings.tables.columns.${l}`,l)}: ${c}`)}"
                            >
                        </label>
                    </td>
                `}).join("");return`
            ...
            `}).join(""))}function Qe(e={}){let t=document.getElementById("accountBodiesMatrixBody");t&&(t.innerHTML=qe().map(n=>{let o=i(f(n)),a=N(n,{size:18,title:f(n)}),c=Z.map(s=>{let l=pe(e?.[s]?.matrix?.rows||{}),r=l?.[n]?.display!==!1?"checked":"",d=l?.[n]?.aspecting!==!1?"checked":"";return`
                    <td>
            ...
            `}).join(""))}function ae(e={}){let t=document.getElementById("accountOrbsHeaderRow"),n=document.getElementById("accountOrbsMatrixBody");if(!t||!n)return;let o=H(),a=C(),s=P(e||T())?.orbs?.profiles?.[y]?.matrix||L(y);t.innerHTML=`
            <th class="account-settings-orb-corner"></th>
            ${o.map(l=>{let r=i(f(l)),d=N(l,{size:18,title:f(l)});return`
                    <th>
                        <span class="account-settings-body account-settings-body--icon-only">
                ...
                `}).join("")}
        `,n.innerHTML=a.map(l=>{let r=l.aspect_type,d=i(te(r)),p=i(R(r));return`
                <tr>
                    <th scope="row">
                        <span class="account-settings-aspect-meta account-settings-aspect-meta--icon-only">
                    ...
                    ${o.map(S=>{let u=s?.[r]?.[S],g=i(f(S));return`
                            <td>
                                <input
            ...
            `}).join(""),Ae(),Be()}function $e(e={}){let t=document.getElementById("accountDignitiesMatrixBody");if(!t)return;let n=V(e?.dignities||{},_?.default_dignities||{}),o=Je(n);t.innerHTML=fe().map(a=>{let c=i(f(a)),s=o[a]||{domicile_primary:[],domicile_secondary:[],detriment_primary:[],detriment_secondary:[],exaltation:[],fall:[]};return`
                <tr>
        ...
        `).join("")}function tt(e={}){let t=document.getElementById("accountAspectColorsBody");if(!t)return;let n=$(e);t.innerHTML=C().map(o=>{let a=o.aspect_type,c=window.AstroPreferences?.getAspectColor?window.AstroPreferences.getAspectColor(a,n):"#9ca3af";return`
                <tr>
                    <th scope="row" class="account-settings-icon-cell">
                        <span class="account-settings-aspect-meta account-settings-aspect-meta--icon-only">
            ...
            `}).join("")}function nt(e={}){let t=document.getElementById("accountElementPaletteBody"),n=document.getElementById("accountBodyOverrideColorsBody");if(!t||!n)return;let o=$(e),a=o?.planet_colors?.element_palette||{},c=o?.planet_colors?.body_overrides||{},s=document.getElementById("accountAngularCuspsBlackToggle");s&&(s.checked=o?.wheel?.angular_cusps_black===!0);let l=document.getElementById("accountExactAspectHighlightToggle");l&&(l.checked=o?.wheel?.highlight_exact_aspects!==!1),t.innerHTML=Object.keys(a).map(r=>`
            <tr>
                <th scope="row">${i(r)}</th>
        ...
        `).join(""),n.innerHTML=H().map(r=>{let d=me(r,o),p=!!c?.[r],S=c?.[r]||d;return`
                <tr>
                    <th scope="row" class="account-settings-icon-cell">
                        <span class="account-settings-body account-settings-body--icon-only">
