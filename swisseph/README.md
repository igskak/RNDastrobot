...
## 🌟 Natal Chart Calculator Programs

This repository includes ready-to-use natal chart calculation programs built on Swiss Ephemeris:

### Programs

**natal_chart** - Text output program
- Human-readable formatted output
- Complete planetary positions, houses, and angles
- Perfect for terminal use and quick viewing

**natal_chart_json** - JSON output program
- Structured JSON format
- Easy integration with web apps and APIs
- Ideal for building astrological applications

### Quick Start

```bash
# Compile
make natal_chart natal_chart_json
...
./natal_chart 15 3 1990 14.5 40.7128 -74.0060 "New York" P

# Get JSON output
./natal_chart_json 15 3 1990 14.5 40.7128 -74.0060 "New York" P
```
...
```bash
# Ensure you have the ephemeris files
# Download de406.eph or other JPL files (see above)
# Place in ./ephe/ directory
