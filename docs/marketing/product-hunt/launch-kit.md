...
| 3 | `gallery/03-assistant.png` | Ответ из данных карты: Плутон по Луне, 3 точных прохода | готово (переснято на проде; `23:59:59` в closest approach уйдёт после серверного форматирования времени) |
