...
**Статус на 2026-09-24:** 1, 2, 3, 4 и 8 исправлены в ветке `claude/product-hunt-launch-07aa2f`
(ещё не на проде). В пункте 8 заодно убраны «recordings» у Practitioner из `/pricing.md` и
...
Studio — нужно решить, что верно. После выкладки переснять слайды 2 и 3.
Остаются 5, 6, 7.
